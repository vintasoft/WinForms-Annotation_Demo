...
namespace AnnotationDemo
{
    ...
    public class AnnotationsToolStrip : ToolStrip
    {
        ...
        ImageViewerToolStrip _viewerToolStrip = null;
        /// <summary>
        /// Gets or sets the <see cref="ImageViewerToolStrip"/>, which is associated with
        /// this <see cref="AnnotationsToolStrip"/>.
        /// </summary>        
        public ImageViewerToolStrip ViewerToolStrip
        {
            get
            {
        ...
        /// Throw if ckecked property of <i>item</i> is not found.
        /// </exception>
