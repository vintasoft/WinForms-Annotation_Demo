...
namespace AnnotationDemo
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            viewerToolStrip.VisualToolChanging += new EventHandler<VisualToolChangingEventArgs>(viewerToolStrip_VisualToolChanging);
        ...
        /// <summary>
        /// ImageViewerToolStrip.VisualToolChanging event handler.
        /// </summary>
        private void viewerToolStrip_VisualToolChanging(object sender, VisualToolChangingEventArgs e)
        {
            annotationViewer1.CancelAnnotationBuilding();

            if (e.NewValue == null)
            {
                e.NewValue = _annotationVisualTool;
                annotationViewer1.AnnotationInteractionMode = AnnotationInteractionMode.Author;
            }
            else if (e.NewValue != _annotationVisualTool)
            {
                annotationViewer1.AnnotationInteractionMode = AnnotationInteractionMode.None;
                CompositeVisualTool compositeTool = new CompositeVisualTool(e.NewValue, _annotationVisualTool);
                compositeTool.ActiveTool = e.NewValue;
                e.NewValue = compositeTool;
            }
        }
            ...
            switch (Path.GetExtension(filename).ToUpperInvariant())
            {
                ...
                case ".TIFF":
                    ...
                    if (showSettingsDialog)
                    {
                        ...
                        tiffEncoderSettingsDlg.AppendExistingDocumentEnabled = isFileExist;
